...
CREATE INDEX IF NOT EXISTS idx_historico_periodo ON historico_mensal(ano_mes,versao_atual,escopo);
CREATE INDEX IF NOT EXISTS idx_historico_referencia ON historico_mensal(escopo,referencia_id,ano_mes);
...
CREATE INDEX IF NOT EXISTS idx_mf_hist_ean_data ON mercado_farma_precos_historico(ean,extraido_em DESC);
CREATE INDEX IF NOT EXISTS idx_mf_hist_uf_dist ON mercado_farma_precos_historico(uf,distribuidora,extraido_em DESC);
