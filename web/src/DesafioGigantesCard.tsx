...
type Produto = {
  ...
  alvo_positivacao_80:number; falta_pdv_80:number; sku_destravado:boolean; giro_atingido:boolean; giro_pontuando:boolean;
}
type Resumo = {
  ano_mes:string; colaborador:string; metas:number; skus:number; identificados:number; pos_80:number;
  giro_bruto_100:number; giro_bruto_120?:number; giro_100:number; giro_80?:number;
...
const vazio:Resumo={ano_mes:'',colaborador:'',metas:0,skus:0,identificados:0,pos_80:0,giro_bruto_100:0,giro_100:0,pontuacao_estimada:0,maximo_estimado:0,oportunidades:[]}
...
export default function DesafioGigantesCard({inicio,consultor,uf}:Props){
  ...
  const giroAtingido=data.giro_bruto_100||0
  const giroAtingidoPct=data.skus?giroAtingido/data.skus*100:0
