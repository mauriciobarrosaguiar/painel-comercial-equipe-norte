...
export function testDatabase() {
  ...
  db.exec(`
    ...
    CREATE TABLE sips(id TEXT PRIMARY KEY,nome TEXT,meta_mes REAL,pagamento_percentual REAL,acesso_publico_ativo INTEGER,ativo INTEGER,atualizado_em TEXT);
    ...
    INSERT INTO itens_pedido(id,pedido_id,produto_id,ean,descricao,quantidade_faturada,valor_faturado,ativo,preco_unitario_sem_imposto,preco_unitario_com_imposto) VALUES
      ...
      ('i3','p1','combate','333','Combate',1,40,1,35,40),
      ('i4','p1','desconhecido','444','Desconhecido',1,10,1,9,10),
      ('i5','p1','linha','111','Linha inativa',1,999,0,0,0),
      ('i6','p2','linha','111','Linha',1,700,1,700,700),
      ('i7','p3','linha','111','Linha',1,800,1,800,800);
    INSERT INTO itens_pedido(id,pedido_id,produto_id,ean,descricao,ativo,valor_total_solicitado_sem_imposto,total_atendido_sem_imposto) VALUES
      ('i8','p4','linha','111','Linha',1,120,120),
      ('i9','p4','prioritario','222','Prioritário',1,80,80),
    ...
    INSERT INTO sip_clientes(sip_id,cnpj,cliente_id,ativo,objetivo_preco_liquido,atualizado_em) VALUES
      ('sip1','11111111000111','cl1',1,400,'2026-07-01'),
      ('sip1','22222222000122','cl2',1,600,'2026-07-01');
    INSERT INTO mercado_farma_precos VALUES
      ('mf1','PA','111','linha','111','Linha','Distribuidora A',10,5,12,15,11,10,'OK','','2026-07-10T12:00:00Z'),
